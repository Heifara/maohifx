...
public final class DraggablePanelsExample extends Application {
	...
	private Node makeDraggable(final Node node) {
		...
		wrapGroup.addEventFilter(MouseEvent.ANY, new EventHandler<MouseEvent>() {
			...
			public void handle(final MouseEvent mouseEvent) {
				if (DraggablePanelsExample.this.dragModeActiveProperty.get()) {
	...
	public void start(final Stage stage) {
		final Node loginPanel = this.makeDraggable(createLoginPanel());
		final Node confirmationPanel = this.makeDraggable(createConfirmationPanel());
		final Node progressPanel = this.makeDraggable(createProgressPanel());
		...
		this.dragModeActiveProperty.bind(dragModeCheckbox.selectedProperty());
